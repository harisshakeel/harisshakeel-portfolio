  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "The integration layer: threading a Pipedream external-user resolver through every Pipedream-facing path so OAuth grants resolve to the right end user rather than a shared project identity. This is the fix that makes per-client tool access genuinely per-client",
