...
const UpworkIcon = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M18.561 13.158c-1.102 0-2.135-.467-3.074-1.227l.228-1.076.008-.042c.207-1.143.849-3.06 2.839-3.06 1.492 0 2.703 1.212 2.703 2.703-.001 1.489-1.212 2.702-2.704 2.702zm0-8.14c-2.539 0-4.51 1.649-5.31 4.366-1.22-1.834-2.148-4.036-2.681-5.892H7.828v7.112c-.002 1.406-1.141 2.546-2.547 2.546-1.405 0-2.543-1.14-2.545-2.546V3.492H0v7.112c0 2.914 2.37 5.303 5.281 5.303 2.913 0 5.283-2.389 5.283-5.303v-1.19c.529 1.107 1.182 2.229 1.974 3.221l-1.673 7.873h2.797l1.213-5.71c1.063.679 2.285 1.109 3.686 1.109 3 0 5.439-2.452 5.439-5.45 0-3-2.439-5.439-5.439-5.439z" />
  </svg>
)
...
export function FooterSection() {
  return (
    <footer className="relative w-full max-w-[1320px] mx-auto flex flex-col items-center justify-center rounded-t-3xl border-t bg-[radial-gradient(35%_128px_at_50%_0%,hsl(var(--foreground)/0.05),transparent)] px-6 py-12 lg:py-16">
      {/* Top glow line */}
      <div className="bg-foreground/20 absolute top-0 right-1/2 left-1/2 h-px w-1/3 -translate-x-1/2 -translate-y-px rounded-full blur-sm" />
        ...
        <AnimatedContainer className="space-y-5">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              aria-label="Haris Shakeel on LinkedIn"
              className="flex h-9 w-9 items-center justify-center rounded-full border border-border/40 text-muted-foreground transition-colors hover:border-primary/40 hover:bg-primary/10 hover:text-primary"
            >
              <LinkedInIcon className="h-4 w-4" />
            </a>
            <a
              href="https://www.upwork.com/freelancers/~014b01aba5c97396c6?viewMode=1"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Haris Shakeel on Upwork"
              className="flex h-9 w-9 items-center justify-center rounded-full border border-border/40 text-muted-foreground transition-colors hover:border-primary/40 hover:bg-primary/10 hover:text-primary"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Haris Shakeel on GitHub"
              className="flex h-9 w-9 items-center justify-center rounded-full border border-border/40 text-muted-foreground transition-colors hover:border-primary/40 hover:bg-primary/10 hover:text-primary"
            >
          ...
          <p className="text-muted-foreground text-xs">
            © {new Date().getFullYear()} Haris Shakeel. All rights reserved.
          </p>
        </AnimatedContainer>
                ...
                <ul className="text-muted-foreground space-y-2.5 text-sm">
                  {section.links.map((link) => (
                    <li key={link.title}>
                      <a
                        href={link.href}
                        className="hover:text-foreground transition-colors duration-200 inline-block"
                      >
                        {link.title}
                      </a>
                    </li>
