...
function CropperCropArea({
  ...
  return (
    <CropperPrimitive.CropArea
      ...
      className={cn(
        "pointer-events-none absolute border-[3px] border-white shadow-[0_0_0_9999px_rgba(0,0,0,0.45)] in-[[data-slot=cropper]:focus-visible]:ring-[3px] in-[[data-slot=cropper]:focus-visible]:ring-white/50",
        className,
      )}
      {...props}
    />
